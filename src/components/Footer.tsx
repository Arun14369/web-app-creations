  ...
  return (
    <footer className="navy-gradient text-white relative overflow-hidden">
      ...
      <div className="container-max px-6 sm:px-8 lg:px-12 py-16 relative z-10">
        <div className="grid md:grid-cols-4 gap-12 lg:gap-16">
          ...
          <div className="md:col-span-1">
            <div className="flex items-center gap-3 mb-5">
              ...
              <span className="font-heading font-bold text-xl tracking-tight text-white">Apex Industries</span>
            </div>
            <p className="text-white/75 text-sm leading-[1.8]">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-semibold text-white text-xs tracking-[0.2em] uppercase mb-6">
              Quick Links
            </h4>
              ...
              {["Home", "About", "Services", "Why Us", "Contact"].map((link) => (
                <li key={link}>
                  <a
                    ...
                    className="text-white/70 text-sm hover:text-white transition-colors duration-300 hover:pl-1"
                  >
                    {link}
                  </a>
                </li>
          ...
          <div>
            ...
            <div className="space-y-4 text-white/70 text-sm">
              ...
              <div className="flex gap-3">
                <Phone className="w-4 h-4 mt-0.5 flex-shrink-0 text-white/50" />
                <span>+91 98765 43210</span>
              </div>
              <div className="flex gap-3">
                <Mail className="w-4 h-4 mt-0.5 flex-shrink-0 text-white/50" />
        ...
        <div className="border-t border-white/15 mt-14 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-white/55 text-sm">
            © 2024 Apex Industries. All rights reserved.
          </p>
          <div className="flex gap-8 text-white/55 text-sm">
