      ...
      <div className="container-max relative">
        ...
        <div className="grid lg:grid-cols-5 gap-12">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className="lg:col-span-3 bg-card rounded-2xl p-8 md:p-10 shadow-card border border-border/40"
          >
            <form onSubmit={(e) => e.preventDefault()} className="space-y-6">
              <div className="grid sm:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-secondary/60 border border-border/60 rounded-lg px-4 py-3.5 text-sm text-foreground placeholder:text-muted-foreground/60 focus:outline-none focus:ring-2 focus:ring-accent/30 focus:border-accent/50 transition-all"
                  />
                </div>
                <div>
                  <label className="text-xs font-semibold text-foreground uppercase tracking-wider mb-2 block">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={5}
                  className="w-full bg-secondary/60 border border-border/60 rounded-lg px-4 py-3.5 text-sm text-foreground placeholder:text-muted-foreground/60 focus:outline-none focus:ring-2 focus:ring-accent/30 focus:border-accent/50 transition-all resize-none"
                />
              </div>
              <button
                type="submit"
                className="w-full btn-premium text-primary font-semibold py-4 rounded-lg flex items-center justify-center gap-3 text-base"
              >
          ...
          >
            {contactInfo.map((item, i) => (
              ...
              >
                <div className="w-12 h-12 rounded-xl navy-gradient flex items-center justify-center flex-shrink-0 shadow-sm">
            ...
            <div className="navy-gradient rounded-2xl p-7 mt-6 relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-primary-foreground/55 text-sm mb-5 leading-relaxed">
                  Need immediate workforce deployment? Call our 24/7 helpline.
                </p>
                <a
                  href="tel:+919876543210"
                  className="text-gradient-gold font-bold text-2xl font-heading inline-block hover:opacity-80 transition-opacity"
                >
                  +91 98765 43210
                </a>
              </div>
